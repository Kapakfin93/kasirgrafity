          ...
          {order?.customerSnapshot && (
            ...
            >
              ...
              {order.customerSnapshot.whatsapp && (
                <span>WA: {order.customerSnapshot.whatsapp}</span>
              )}
            </div>
          )}
          ...
          <div className="nota-items">
            {items.map((item, idx) => {
              ...
              const specialNote =
                ...
                item.meta?.notes ||
                item.meta?.detail_options?.notes ||
                null;
              ...
              return (
                <div key={item.id || idx} className="nota-item">
                  ...
                  {/* === CATATAN KHUSUS - SPK ONLY (Bold & Prominent) === */}
                  {printMode === "SPK" && specialNote && (
                    <div
                      style={{
                        marginTop: "6px",
                        padding: "8px 10px",
