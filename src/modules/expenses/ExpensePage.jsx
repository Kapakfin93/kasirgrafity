...
export function ExpensePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    description: "",
    employeeName: "",
    csName: "", // CS name for this expense
  });
  ...
  const handleCsNameChange = (e) => {
    ...
    setFormData({ ...formData, csName: value });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addExpense({
        ...
        employeeName:
          formData.category === "SALARY" ? formData.employeeName : null,
        createdBy: formData.csName.trim(),
      });
  ...
  const currentExpenses =
    activeTab === "operational" ? operationalExpenses : payrollExpenses;
        ...
        <div className="expense-summary-card expense-total">
          ...
          <div className="summary-content">
            ...
            <div className="summary-breakdown">
              <span className="breakdown-item ops">
                Ops: {formatRupiah(totalOperational)}
              </span>
              <span className="breakdown-divider">|</span>
              <span className="breakdown-item payroll">
            ...
            <form onSubmit={handleSubmit} className="expense-form">
              ...
              <div className="form-field">
                ...
                <input
                  ...
                  className="description-input"
                  style={{
                    borderColor: csNameError ? "#ef4444" : undefined,
                  }}
                />
                {csNameError && (
                  <div
