...
const OFFICE_PRODUCTS = [
    ...
    variants: [
      {
        ...
        desc: "Nota biasa tanpa copy, untuk struk sederhana.",
        price_list: {
      ...
      },
      {
        ...
        desc: "Nota 2 rangkap, otomatis copy ke lembar bawah.",
        price_list: {
      ...
      },
      {
        ...
        desc: "Nota 3 rangkap, untuk arsip toko & customer.",
        price_list: {
      ...
      },
      {
        ...
        desc: "Nota 4 rangkap lengkap, untuk bisnis besar.",
        price_list: {
  ...
  // 2. MASTER KALENDER
  {
    ...
    variants: [
      {
        label: "Meja Standar",
        specs: "21x15 cm | 7 Lbr (Bolak Balik)",
        desc: "Kalender meja lipat, cocok untuk souvenir promosi.",
        price: 25000,
      },
      {
        label: "Meja Premium",
        specs: "21x15 cm | 13 Lbr (1 Bulanan)",
        desc: "Kalender meja premium, satu bulan per halaman.",
        price: 35000,
      },
      {
        label: "Dinding Poster",
        specs: "32x48 cm (A3+) | 1 Lembar AC",
        desc: "Kalender poster 1 lembar, praktis & murah.",
        price: 5000,
      },
      {
        label: "Dinding 6 Lbr",
        specs: "32x48 cm (A3+) | AP 150gr",
        desc: "Kalender dinding 6 bulan, 2 bulan per lembar.",
        price: 17500,
      },
      {
        label: "Dinding 12 Lbr",
        specs: "32x48 cm (A3+) | AP 150gr",
        desc: "Kalender dinding 1 tahun penuh, satu bulan per lembar.",
        price: 32000,
      },
    ],
    finishing_groups: [
      ...
      },
      {
        ...
        type: "checkbox",
        required: false,
        options: [{ label: "Plastik Satuan", price: 500 }],
      },
    ],
    is_active: 1,
    is_archived: 0,
  ...
  // 3. MASTER MAP IJAZAH
  {
    ...
    variants: [
      {
        label: "Standard",
        specs: "ASE Tipis | Logo Hotprint",
        desc: "Map ijazah standar, ekonomis untuk sekolah.",
        price: 15000,
      },
      {
        label: "Medium",
        specs: "ASE Tebal | Siku Emas",
        desc: "Map ijazah dengan siku emas, tampil lebih rapi.",
        price: 22000,
      },
      {
        label: "Premium",
        specs: "Lapis Busa | Full Foil | Siku",
        desc: "Map ijazah eksklusif dengan busa & foil mewah.",
        price: 35000,
      },
    ],
    finishing_groups: [
  ...
  // 4. MASTER BUKU YASIN
  {
    ...
    variants: [
      {
        label: "Softcover 180",
        specs: "Isi HVS | Cover ArtCarton",
        desc: "Buku yasin tipis, ekonomis untuk tahlilan.",
        price: 15000,
      },
      {
        label: "Softcover 280",
        specs: "Isi HVS | Cover ArtCarton",
        desc: "Buku yasin tebal, isi lengkap dengan doa.",
        price: 22000,
      },
      {
        label: "Hardcover 180",
        specs: "Isi HVS | Cover RCP/Linen",
        desc: "Buku yasin sampul keras, tahan lama.",
        price: 30000,
      },
      {
        label: "Hardcover 280",
        specs: "Isi HVS | Cover RCP/Linen",
        desc: "Buku yasin premium tebal, untuk kenang-kenangan.",
        price: 45000,
      },
    ],
    finishing_groups: [
    ...
    variants: [
      {
        ...
        desc: "Kop surat ekonomis, untuk penggunaan harian.",
        price: 150000,
      },
      {
        label: "HVS 80gr",
        specs: "Standard Premium",
        desc: "Kop surat standar, kertas lebih tebal & rapi.",
        price: 185000,
      },
      {
        label: "HVS 100gr",
        specs: "Eksklusif (Tebal)",
        desc: "Kop surat premium, kesan profesional.",
        price: 220000,
      },
      {
        label: "Concorde",
        specs: "Bertekstur / Mewah",
        desc: "Kop surat bertekstur mewah untuk surat resmi VIP.",
        price: 300000,
      },
    ],
    finishing_groups: [
  ...
  // 6. MASTER STEMPEL FLASH
  {
    ...
    variants: [
      {
        label: "Ukuran Kecil",
        specs: "Bulat (17-23mm) / Persegi Kecil",
        desc: "Stempel kecil, cocok untuk paraf & inisial.",
        price: 35000,
      },
      {
        label: "Ukuran Sedang",
        specs: "Bulat (25-40mm) / Persegi Std",
        desc: "Stempel standar untuk cap toko & kantor.",
        price: 55000,
      },
      {
        label: "Ukuran Besar",
        specs: "Bulat (42-51mm) / Persegi Jumbo",
        desc: "Stempel besar untuk logo & cap resmi.",
        price: 85000,
      },
    ],
    finishing_groups: [
      {
        ...
        type: "checkbox",
        required: false,
        options: [{ label: "Tinta Refill (5ml)", price: 10000 }],
      },
    ],
    is_active: 1,
    is_archived: 0,
...
export async function runOfficeReconstruction() {
  ...
  try {
    ...
    for (const masterProduct of OFFICE_PRODUCTS) {
      ...
      console.log(
        `      Variants: ${masterProduct.variants?.length || 0} (with specs)`,
      );
    }
