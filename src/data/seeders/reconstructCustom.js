...
const CUSTOM_PRODUCTS = [
  // PRINT DOKUMEN has been MOVED to Digital A3+ category (reconstructDigitalA3.js)
  // It now uses BOOKLET mode with print_modes array for proper duplex handling

  // 1. MASTER JASA JILID & FINISHING (Service Only)
  // For customers bringing their own paper
  {
    ...
    variants: [
      {
        label: "Jilid Lakban (Tape)",
        specs: "Cover Mika Bening + Buffalo",
        price: 5000,
      },
      {
        label: "Jilid Spiral Plastik",
        specs: "Ring Plastik + Cover",
        price: 10000,
      },
      { label: "Jilid Spiral Kawat", specs: "Ring Besi + Cover", price: 20000 },
      {
        label: "Softcover (Binding Lem)",
        specs: "Cover Full Color + Laminasi",
        price: 30000,
      },
      {
        label: "Hardcover (Skripsi)",
        specs: "Board Tebal + Tinta Emas",
        price: 50000,
      },
      {
        label: "Laminasi Dokumen (A4/F4)",
        specs: "Press Panas (Per Lembar)",
        price: 5000,
      },
    ],
    is_active: 1,
  ...
  // 3. MASTER JASA DESAIN
  {
    ...
    variants: [
      ...
      {
        label: "Desain Standar",
        specs: "Layout Banner/Brosur/Stiker",
        price: 35000,
      },
      {
        label: "Desain Premium",
        specs: "Konsep Baru/Vector/Logo",
        price: 75000,
      },
      {
        label: "Redraw / Tracing",
        specs: "Gambar Ulang Logo Pecah",
        price: 50000,
      },
    ],
    is_active: 1,
  ...
  // 4. MASTER ONGKOS KIRIM
  {
    ...
    variants: [
      ...
      {
        label: "Ekspedisi / Custom",
        specs: "JNE/J&T/Gosend (Sesuaikan Harga)",
        price: 1000,
      }, // Admin overrides total
    ],
    is_active: 1,
    is_archived: 0,
  },
  ...
  // 5. MASTER INPUT MANUAL (Wildcard)
  {
    ...
    variants: [
      {
        label: "Item Custom (x1000)",
        specs: "Input Qty = Harga (Cth: 50rb = Qty 50)",
        price: 1000,
      },
