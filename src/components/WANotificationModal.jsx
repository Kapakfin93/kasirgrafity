...
import { isValidPhone, generateWALink, generateCompletionMessage, generateDeliveryMessage } from '../utils/waHelper';
...
export function WANotificationModal({
    ...
    useEffect(() => {
        if (isOpen && order) {
            const initialMessage = actionType === 'DELIVER'
        ...
        <div className="wa-modal-overlay" onClick={onCancel}>
            <div className="wa-modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="wa-modal-header">
                    <h3>{getTitle()}</h3>
                    <button className="wa-modal-close" onClick={onCancel}>×</button>
                </div>
                ...
                <div className="wa-modal-body">
                    ...
                    <div className={`wa-payment-status ${isLunas ? 'lunas' : 'belum-lunas'}`}>
                        {isLunas ? (
                            <>✅ LUNAS</>
                        ) : (
                    ...
                    {/* Status Change Info */}
                    <div className="wa-status-change">
                        📋 {getStatusText()}
                    </div>
                </div>
                ...
                <div className="wa-modal-footer">
                    ...
                    <button
                        className="wa-btn wa-btn-silent"
